...
class Nozzle: # isentropic converging-diverging (DeLaval) nozzle class
    ...
    def get_check(self):
        ...
        print("self.R", self.R)
        print("self.choked", self.choked)
        print("self.P_b", self.P_b)
        print("self.P_0", self.P_0)
        print("self.T_0", self.T_0)
        print("self.rho_0", self.rho_0)
        print("self.flowrate", self.gamma)
        print("self.P_star", self.P_star)
        print("self.T_star", self.T_star)
        print("self.rho_star", self.rho_star)
        print("self.P_exit", self.P_exit)
        print("self.T_exit", self.T_exit)
        print("self.rho_exit", self.rho_exit)
        print("self.M_exit",self.M_exit)
        print("self.speed_of_sound_exit",self.speed_of_sound_exit)